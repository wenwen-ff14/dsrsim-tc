...
public sealed partial class DsrP6DragonsScenario(DsrP6Section section=DsrP6Section.Full) : IScenario
{
    ...
    public void Run(SimWorld simWorld,int? selectedAi)
    {
        ...
        world.Events.Add(59.148f,()=>{nidhogg?.Cast(27973,castSeconds:2.2f,fireDelay:.259f);PrepareWroth();});
        ...
        world.Events.Add(142.914f,()=>{nidhogg?.Cast(27966,new Vector3(-10,0,40),4.7f,fireDelay:.263f);hraesvelgr?.Cast(27967,new Vector3(10,0,40),4.7f,fireDelay:.263f);state.SetDoubleDive();});
